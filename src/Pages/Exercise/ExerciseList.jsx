...
const ExerciseList = () => {
    ...
    const fetchExercises = async () => {
        ...
        try {
            setLoading(true);
            const response = await axios.get(`https://exercisedb.p.rapidapi.com/exercises/bodyPart/${sanitizedSearchTerm}`, {
                headers: {
    ...
    const searchVideos = async (exercises) => {
        ...
        for (const exercise of exercises) {
            try {
                const response = await axios.get(`https://www.googleapis.com/youtube/v3/search?q=${exercise.name}&part=snippet&type=video&key=AIzaSyBw1uRTZvSK5gx6dAzCFsAFWfEZmRcD-G8`);
            ...
            <table className='exertable' align='center'>
                <tr>
                    ...
                    <td><Slider {...settings} ref={sliderRef} className='exerSlider'>
                            <Button className="slider-item" value={searchTerm}><img src={bodypart} onClick={handleSearchClick}/><br/>Back</Button>
                            <Button className="slider-item"><img src={bodypart}/><br/>Cardio</Button>
                            <Button className="slider-item"><img src={bodypart}/><br/>Chest</Button>
                            <Button className="slider-item"><img src={bodypart}/><br/>Lower arms</Button>
                            <Button className="slider-item"><img src={bodypart}/><br/>Lower legs</Button>
                            <Button className="slider-item"><img src={bodypart}/><br/>Neck</Button>
                            <Button className="slider-item"><img src={bodypart}/><br/>Shoulder</Button>
                            <Button className="slider-item"><img src={bodypart}/><br/>Upper arms</Button>
